...
// function MealPlanCard({ mealPlan, onEditClick, onGenerate, onExport, generating }) {
...
function MealPlanCard({ mealPlan, onEditClick, onGenerate, onExport, generating, polling }) {
  ...
  return (
    ...
    >
      ...
      {/* POLLING BANNER */}
      {polling && (
        <div className="flex items-center gap-3 mx-8 mt-5 p-4 bg-amber-50 border border-amber-200 rounded-xl">
          <Loader2 size={18} className="animate-spin text-amber-500 shrink-0" />
          <p className="text-amber-700 text-sm">
            AI planı hazırlayır, bir az gözləyin...
          </p>
        </div>
      )}
