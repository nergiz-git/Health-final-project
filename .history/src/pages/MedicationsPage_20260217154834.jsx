            ...
            >
              ...
              <div className="flex gap-3 mt-4 ml-14">
                <button
                  ...
                  className="flex w-[200px] ml-[35px] items-center gap-1 bg-white border !border-blue-600 px-3 py-1 rounded-lg text-blue-600 justify-center transition-colors duration-200 hover:!bg-blue-100 hover:text-black"
                >
