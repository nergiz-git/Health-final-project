            ...
            >
              ...
              <div className="flex gap-3 mt-4 ml-14">
                <button
                  ...
                  className="flex items-center gap-2 border border-blue-300 px-4 py-2 rounded-lg text-blue-600 hover:bg-blue-50 transition-all font-medium"
                >
                ...
                <button
                  ...
                  className="flex items-center gap-2 border border-red-300 px-4 py-2 rounded-lg text-red-600 hover:bg-red-50 transition-all font-medium"
                >
                  <Trash2 size={16} /> Sil
                </button>
              </div>
